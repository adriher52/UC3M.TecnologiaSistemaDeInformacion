...
public class Measurement
{
    ...
    private static void testPerformanceSerialization(ReferenceData referenceData, Lesson9.ReferenceData referenceDataProto)
    {
        ...
        System.out.println("media Serialización Jaxb = " +meanJaxb);
        ...
        System.out.println("media Serialización Json= " +meanJson);
        ...
        System.out.println("media Serialización Proto= " +meanProto);
        ...
        System.out.println("media Serialización Kryo= " +meanKryo);
    }
    ...
    {
        System.out.println("Deserealización .");
        //JAXB serialization
        long jaxbSerializationIni = System.nanoTime();
        for (int i = 0; i < NUM_ITERATIONS; i++)
        {
        ...
        long jaxbSerializationFin = System.nanoTime();
        long meanJaxb = (jaxbSerializationFin - jaxbSerializationIni)/NUM_ITERATIONS;
        System.out.println("media Desrialización Jaxb = " +meanJaxb);
        ...
        long jsonSerializationFin = System.nanoTime();
        long meanJson = (jsonSerializationFin - jsonSerializationIni)/NUM_ITERATIONS;
        System.out.println("media Desrialización  Json= " +meanJson);
        ...
        long protoSerializationFin = System.nanoTime();
        long meanProto = (protoSerializationFin - protoSerializationIni)/NUM_ITERATIONS;
        System.out.println("media Desrialización Proto= " +meanProto);
        ...
        long kryoSerializationFin = System.nanoTime();
        long meanKryo = (kryoSerializationFin - kryoSerializationIni)/NUM_ITERATIONS;
        System.out.println("media Desrialización Kryo= " +meanKryo);
    }
    ...
    {
        System.out.println("Serealización y deserealización.");
        //JAXB serialization
        long jaxbSerializationIni = System.nanoTime();
        for (int i = 0; i < NUM_ITERATIONS; i++)
        {
        ...
        long jaxbSerializationFin = System.nanoTime();
        long meanJaxb = (jaxbSerializationFin - jaxbSerializationIni)/NUM_ITERATIONS;
        System.out.println("media Serealización y deserealización Jaxb= " + meanJaxb);
        ...
        long jsonSerializationFin = System.nanoTime();
        long meanJson = (jsonSerializationFin - jsonSerializationIni)/NUM_ITERATIONS;
        System.out.println("media Serealización y deserealización  Json= " +meanJson);
        ...
        long protoSerializationFin = System.nanoTime();
        long meanProto = (protoSerializationFin - protoSerializationIni)/NUM_ITERATIONS;
        System.out.println("media Serealización y deserealización Proto= " +meanProto);
        ...
        long kryoSerializationFin = System.nanoTime();
        long meanKryo = (kryoSerializationFin - kryoSerializationIni)/NUM_ITERATIONS;
        System.out.println("media Serealización y deserealización Kryo= " +meanKryo);
    }
}
